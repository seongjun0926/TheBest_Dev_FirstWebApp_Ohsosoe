...
<body>
	...
	try {
		...
		int Out_count = Integer.parseInt(request.getParameter("Group_count"));

		for (int i = 1; i <= Out_count; i++) {
			String str1 = "GroupActivity" + i;
			String str2 = "Group_Period" + i;
			String str3 = "Group_Context" + i;
			String str4 = "Group_job"+i;
	
			Value_str1 = request.getParameter(str1);
			Value_str2 = request.getParameter(str2);
			Value_str3 = request.getParameter(str3);
			Value_str4 = request.getParameter(str4);
			
			if (Value_str1!= null && Value_str2!=null && Value_str3!=null && Value_str4!=null) {
