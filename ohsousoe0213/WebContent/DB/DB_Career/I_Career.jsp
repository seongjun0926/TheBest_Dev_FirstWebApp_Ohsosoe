...
<body>
	...
	try {
		...
		int Intern_count = Integer.parseInt(request.getParameter("Intern_count"));

		for (int i = 1; i <= Intern_count; i++) {
			String str1 = "InternActivity" + i;
			String str2 = "Intern_Period" + i;
			String str3 = "Intern_Context" + i;
