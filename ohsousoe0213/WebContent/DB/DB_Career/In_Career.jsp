...
<body>
	...
	try {
		...
		int In_count = Integer.parseInt(request.getParameter("In_count"));

		for (int i = 1; i <= In_count; i++) {
			String name = "name";
			String str1 = "InActivity" + i;
			String str2 = "In_Period" + i;
			String str3 = "In_Context" + i;
