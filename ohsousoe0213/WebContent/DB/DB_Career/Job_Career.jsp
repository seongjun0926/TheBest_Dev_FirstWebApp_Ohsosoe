...
<body>
	...
	<%
		...
		int Job_count = Integer.parseInt(request.getParameter("Job_count"));

		for (int i = 1; i <= Job_count; i++) {
			String str1 = "JobActivity" + i;
			String str2 = "Job_Period" + i;
			String str3 = "Job_Context" + i;
