...
<body>
	...
	<%
		...
		int Lan_count = Integer.parseInt(request.getParameter("Lan_count"));

		for (int i = 1; i <= Lan_count; i++) {
			String str1 = "LanActivity" + i;
			String str2 = "Lan_Period" + i;
			String str3 = "Lan_Context" + i;
