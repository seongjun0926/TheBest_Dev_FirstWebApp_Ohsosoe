...
<body>
	...
	try {
		...
		int Vol_count = Integer.parseInt(request.getParameter("Vol_count"));

		for (int i = 1; i <= Vol_count; i++) {
			String str1 = "VolActivity" + i;
			String str2 = "Vol_Period" + i;
			String str3 = "Vol_Context" + i;
