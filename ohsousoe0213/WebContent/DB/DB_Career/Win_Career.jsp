...
<body>
	...
	try {
		...
		int Win_count = Integer.parseInt(request.getParameter("Win_count"));

		for (int i = 1; i <= Win_count; i++) {
			String name = "name";
			String str1 = "WinActivity" + i;
			String str2 = "Win_Period" + i;
			String str3 = "Win_Context" + i;
